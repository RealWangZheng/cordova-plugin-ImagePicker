...
@implementation UIView (IDSLayout)
...
+ (void)showOscillatoryAnimationWithLayer:(CALayer *)layer type:(IDSOscillatoryAnimationType)type{
    NSNumber *animationScale1 = type == IDSOscillatoryAnimationToBigger ? @(1.15) : @(0.5);
    NSNumber *animationScale2 = type == IDSOscillatoryAnimationToBigger ? @(0.92) : @(1.15);
