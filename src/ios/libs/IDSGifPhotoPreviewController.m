...
@interface IDSGifPhotoPreviewController () {
    UIView *_toolBar;
    UIButton *_doneButton;
    UIProgressView *_progress;
    
    IDSPhotoPreviewView *_previewView;
    
    UIStatusBarStyle _originStatusBarStyle;
}
@end

@implementation IDSGifPhotoPreviewController
...
- (void)configPreviewView {
    ...
    __weak IDSGifPhotoPreviewController *weakSelf = self;
    [_previewView setSingleTapGestureBlock:^{
        __strong IDSGifPhotoPreviewController *strongSelf = weakSelf;
...
- (void)configBottomToolBar {
    ...
    [[IDSImageManager manager] getPhotosBytesWithArray:@[_model] completion:^(NSString *totalBytes) {
