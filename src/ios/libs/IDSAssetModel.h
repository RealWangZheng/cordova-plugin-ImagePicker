...
typedef enum : NSUInteger {
    IDSAssetModelMediaTypePhoto = 0,
    IDSAssetModelMediaTypeLivePhoto,
    IDSAssetModelMediaTypePhotoGif,
    IDSAssetModelMediaTypeVideo,
    IDSAssetModelMediaTypeAudio
} IDSAssetModelMediaType;

@class PHAsset;
@interface IDSAssetModel : NSObject

@property (nonatomic, strong) id asset;             ///< PHAsset or ALAsset
@property (nonatomic, assign) BOOL isSelected;      ///< The select status of a photo, default is No
@property (nonatomic, assign) IDSAssetModelMediaType type;
...
@class PHFetchResult;
@interface IDSAlbumModel : NSObject
